...
saveRDS(hay, directory( "thesis/Data/Constructed Datasets/hay_co_monthly_ams_dm.Rds"))
...
saveRDS(hay, directory( "thesis/Data/Constructed Datasets/hay_co_monthly_ams_dm_spei.Rds"))
